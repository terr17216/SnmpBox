...
Пакет исключает необходимость прямого взаимодействия WEB сервера и SNMP-клиента. 
Отправка SNMP запросов и получение результатов проходит через брокер сообщений (на релизе 1.0.5 это Redis).
